...
let auth: Record<string, unknown> = { entrar, entrarComGoogle, isAnonymous: true, loading: false };
...
beforeEach(() => {
  vi.clearAllMocks();
  auth = { entrar, entrarComGoogle, isAnonymous: true, loading: false };
...
describe("Home — login", () => {
  ...
  it("usuário já logado é redirecionado para /entrar e não vê o login", async () => {
    auth = { entrar, entrarComGoogle, isAnonymous: false, loading: false };
    render(<HomePage />);
